...
export class ViewCompaniesComponent implements OnInit, OnDestroy{
  ...
  onView(selectedItem: any) {
    ...
    this.data = {
      ...
      CompanyType: selectedItem.CompanyType.replace("CompanyTypeEnum.", ''),
        ...
        this.formGroup.patchValue(
          {
           ...
           CompanyType: this.authservice.stripFormValue(this.updatevalue.CompanyType.replace("CompanyTypeEnum.", '')),
