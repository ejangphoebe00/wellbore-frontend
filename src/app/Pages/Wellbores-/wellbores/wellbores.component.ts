...
export class WellboresComponent implements OnInit {
    ...
    this.http.get('http://127.0.0.1:8899/apiv1/get_wellbore/' + this.id)
      .subscribe(response => {
        ...
        this.formGroup.patchValue({
          ...
          DSTContractorId: this.authservice.stripFormValue(this.updatevalue.DST_ContractorId),
  ...
  initForm() {
    this.formGroup = new FormGroup({
      ...
      MDT_DoneId: new FormControl(),
      FET_DoneId: new FormControl(),
      WFTContractor: new FormControl(),
      DST_DoneId: new FormControl(),
      ManifoldFlowTestedId: new FormControl(),
      DST_ContractorId: new FormControl(),
